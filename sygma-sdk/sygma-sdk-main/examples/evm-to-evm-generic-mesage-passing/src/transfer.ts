...
const EXECUTE_CONTRACT_ADDRESS = "0x8f3D1e172FC6538bc5E9A1e5D6D91D1096F98aE2";
...
const fetchAfterValue = async (): Promise<BigNumber> => {
  ...
  console.log("Address passed to retrieve function: ", address);
  return await storageContract.retrieve(address);
};
